...
uses
  ...
  wwclient, Menus, MConnect, stdctrls;
type
  ...
  private
    ...
    FTabla3Filter: String;
    FTabla4Filter: String;
    FTabla5Filter: String;
    FTabla6Filter: String;
  ...
  protected
    ...
    procedure SetDCOMC(Value :TDCOMConnection);
...
//    property  User : String read FUser write FUser;
  ...
  published
    ...
    property Tabla3        : String   read FTabla3         write FTabla3;
    property Tabla3Llave   : String   read FTabla3LLave    write FTabla3Llave;
    property Tabla3Order   : String   read FTabla3Order    write FTabla3Order;
    property Tabla3Filter  : String   read FTabla3Filter   write FTabla3Filter;
    property Tabla4        : String   read FTabla4         write FTabla4;
    property Tabla4Llave   : String   read FTabla4LLave    write FTabla4Llave;
    property Tabla4Order   : String   read FTabla4Order    write FTabla4Order;
    property Tabla4Filter  : String   read FTabla4Filter   write FTabla4Filter;
    property Tabla5        : String   read FTabla5         write FTabla5;
    property Tabla5Llave   : String   read FTabla5LLave    write FTabla5Llave;
    property Tabla5Order   : String   read FTabla5Order    write FTabla5Order;
    property Tabla5Filter  : String   read FTabla5Filter   write FTabla5Filter;
    property Tabla6        : String   read FTabla6         write FTabla6;
    property Tabla6Llave   : String   read FTabla6LLave    write FTabla6Llave;
    property Tabla6Order   : String   read FTabla6Order    write FTabla6Order;
    property Tabla6Filter  : String   read FTabla6Filter   write FTabla6Filter;
    ...
    property DComC         : TDCOMConnection  read FDComC           write SetDComC;
...
//          Z2btnActReg.OnClick := FOnInsert;
     ...
     FMant.wTabla3      := FTabla3;
     FMant.wTabla3LLave := FTabla3LLave;
     FMant.wTabla3Order := FTabla3Order;
     FMant.wTabla4      := FTabla4;
     FMant.wTabla4LLave := FTabla4LLave;
     FMant.wTabla4Order := FTabla4Order;
     FMant.wTabla5      := FTabla5;
     FMant.wTabla5LLave := FTabla5LLave;
     FMant.wTabla5Order := FTabla5Order;
     FMant.wTabla6      := FTabla6;
     FMant.wTabla6LLave := FTabla6LLave;
     FMant.wTabla6Order := FTabla6Order;
        ...
        end;
 {
     ...
     result := FMant.Execute( FTableName,   FModule,
                              ...
                              FTabla3Filter,FTabla4Filter,
                              FTabla5Filter,FTabla6Filter,
...
procedure TMant.SetDCOMC(Value :TDCOMConnection);
begin
 FDComC := Value;
 if FDComC <> nil then
 begin
